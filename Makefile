...
STATS_2=tst2-count.txt tst2-rand.txt tst2-fifo.txt tst2-lru.txt tst2-lfu.txt tst2-gc.txt
STATS_3=tst3-count.txt tst3-rand.txt tst3-fifo.txt tst3-lru.txt tst3-lfu.txt tst3-gc.txt

COMMAND=./simulador 40 1024
